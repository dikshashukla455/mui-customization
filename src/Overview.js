		...
		<div>
			...
			<div style={{ margin: "2rem 0 0 3rem" }}>
				...
				<Typography variant="bodyMedium">
					The color(text color and background color) can be customizable based
					on <br />
					<br />
					using color palette -
					<ul>
				...
				<Typography variant="bodyMedium">
					The buttons can be customizable based on using style overrides or{" "}
					<br />
					<br />
					using color palette -
					<ul>
				...
				<Typography variant="bodyMedium">
					...
					color) based on
					<br /> label prop, value(position) prop and other default props or
					using style overrides.(MuiRadio and MuiCheckbox).
				</Typography>
				<br /> <br />
				...
				<Typography variant="bodyMedium">
					...
					using style overrides(MuiMenu and MuiMenuItem) for the custom
					variants.
				</Typography>
				<br />
				<br />
